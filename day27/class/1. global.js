...
//globarThis 객체를 사용해서 전역변수를 설정하고 함수 내부에서 변수 값을 변경
//globarThis는 자바스크립트 환경에 따라 전역객체에 접근하는 달라 코드의 이식성이 떨어지는것을
//극복하기 위해 도입된 표준화된 방법

//globarThis를 이용한 전역 문자열
globalThis.str = "hello" // 전역객체에 str변수를 선언
