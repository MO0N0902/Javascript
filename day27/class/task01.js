...
//2) 이름만 출력
for(let key in students3.name){
  console.log(`이름 : ${students3[key]}`);
}
...
console.log("2배 증가한 배열:", Numbers2);
//2) 배열의 길이를 구하고 출력하기
console.log('배열의 길이 :'+Numbers2.length);
...
const indexCat = animals.indexOf('cat');
console.log("'cat'의 인덱스:", indexCat);
//5) 배열의 첫번째와 마지막요소를 제거한 뒤 남은 배열 출력하기
const colors = ['red', 'blue', 'green', 'yellow'];
colors.shift();  // 첫 번째 요소 제거
colors.pop();    // 마지막 요소 제거

console.log("결과배열:", colors);
